...
function initWebApp(){
	...
	if(isDevice){
		if(!navigator.standalone) {
			...
			$('body').addClass('webapp-instructions').css('background','#fff)').append('<img style="'+styleStr+'" src="QRCODE01/assets/images/add_to_home_'+nameForDeviceFile+'.png" />');
			return !0;
		}
		...
		(location.protocol == 'file:' ? '%28Post%20to%20a%20web%20server%20to%20show%20URL%29' : location.href) +'"><img src="QRCODE01/assets/images/non_'+nameForNonDeviceFile+'.png';
